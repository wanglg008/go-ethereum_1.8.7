...
// newNotifier creates a new notifier that can be used to send subscription newNotifier方法创建了一个notifier对象存储到ctx中。可以观察到
// notifications to the client.                      Notifier对象保存了codec的实例，即Notifier对象保存了网络连接，用来在需要的时候发送数据。
