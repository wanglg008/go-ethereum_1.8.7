...
// SubmitWork tries to inject a pow solution into the remote agent, returning     远程矿工会调用这个方法提交挖矿的结果。 
// whether the solution was accepted or not (not can be both a bad pow as well as 对结果进行验证之后提交到returnCh
