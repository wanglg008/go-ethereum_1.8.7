...
func (t *Trie) Prove(key []byte, fromLevel uint, proofDb ethdb.Putter) error { //获取指定Key的proof证明，proof证明是从根节点到叶子节点的所有节点的hash值列表。
...
// VerifyProof方法接受一个roothash值和proof证明和key来验证key是否存在
