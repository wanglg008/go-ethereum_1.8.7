...
func (c *Contract) AsDelegate() *Contract {//将合约设置为委托调用并返回当前合同
	c.DelegateCall = true
...
// GetOp returns the n'th element in the contract's byte array  用来获取下一跳指令
